...
public class MovementScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        bool enSuelo = Physics.Raycast(transform.position, Vector3.down, 2f);
        ...
        Vector3 offset = transform.rotation * new Vector3(0, 85f, 15f);
        ...
        Vector3 offset2 = transform.rotation * new Vector3(0, 85f, 0);
        flashLight.position = transform.position+ offset;
